...
위 소재 각도와 이 지역을 함께 만족하는 사건을 찾아라. 둘 다 맞는 사건이 정말 없으면 지역을 우선하고 각도는 가장 가까운 것으로 조정해도 된다.`,
    ...
    "- 세그먼트 28~34개(짧게 요청하면 10~12개). 첫 1~2개 강한 훅, 중반 오픈루프, 후반 반전, 마지막은 사인오프.",
    ...
    "[컷 연결] ★모든 컷은 다음 컷이 궁금해지게 끝나야 한다. (1) 새 정보를 던지되 그 의미/결과는 다음 컷에서 밝혀라 — '근데 그 수첩이 문제였어요'로 끊고 다음 컷에서 내용 공개. (2) 3~4컷마다 하나는 일부러 미완결로 끊어 떡밥을 남겨라. (3) ★굵직한 새 의문(리훅)을 전체의 1/4, 2/4, 3/4 지점에 하나씩 총 3개 배치하라 — 길어진 만큼 중간 이탈을 막는 가장 중요한 장치다. 각 리훅은 '아직 안 끝났구나'를 느끼게 하는 새 사실이어야 한다. (4) 앞 컷의 마지막 소재를 다음 컷 첫머리가 물려받아 도미노처럼 이어지게(끊긴 느낌 금지).",
