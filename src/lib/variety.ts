 ...
 *
 * ★'이거 지어낸 얘기 아니에요' 류의 실화 선언은 가중치 1로 눌렀다.
...
const HOOK_STYLES: Array<{ weight: number; pick: string }> = [
  ...
  {
    weight: 1,
    pick: "훅 방식: '실화 선언형' — 첫 문장에서 지어낸 얘기가 아님을 밝히며 시작. 예: '이거 지어낸 얘기 아니에요. 1922년에 실제로 있었던 일이거든요.' (이 방식은 자주 반복되면 시청자가 질리니 이번 회차에만 쓴다. 문구도 예시 그대로 베끼지 말고 새로 지어라.)",
  },
];
